...
public class MatchAnalyzerv6
{
    public static void main (String [] args) throws IOException 
    {
        ...
        do{    
            ...
            File myFile = new File("DataFiles/" + fName + ".xlsx");//CHANGE NAME TO CURRENT COMPETITION
        ...
        /*
            TO DO
            add in OPR/CCWM calculation (Figure out formula)
                http://www.team2834.com/team_documents/Team2834_ScoutingDatabasePresentation_2012.pdf
        */
            ...
            os.close();
            System.out.print("Would you like to do another file? (y/n) :: ");
            choice = sc.next();
